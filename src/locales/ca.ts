...
export default {
  ...
  'terms.refundPolicyContact': 'Per a sol·licituds de reemborsament, contacteu-nos a info@elektr-ame.com amb els detalls de la vostra comanda.',
  'terms.payment': 'Mètodes de Pagament',
  'terms.paymentText': 'Acceptem pagaments a través de PAYCOMET. Totes les transaccions es processen de forma segura. La vostra informació de pagament està encriptada i segura.',
  ...
  'terms.contactText': 'Per a preguntes sobre aquests termes i condicions, contacteu-nos a info@elektr-ame.com'
};

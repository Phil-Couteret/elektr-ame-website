...
export default {
  ...
  'terms.refundPolicyContact': 'Para solicitudes de reembolso, contáctenos en info@elektr-ame.com con los detalles de su pedido.',
  'terms.payment': 'Métodos de Pago',
  'terms.paymentText': 'Aceptamos pagos a través de PAYCOMET. Todas las transacciones se procesan de forma segura. Su información de pago está encriptada y segura.',
  ...
  'terms.contactText': 'Para preguntas sobre estos términos y condiciones, contáctenos en info@elektr-ame.com'
};

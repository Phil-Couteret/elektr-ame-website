...
export default {
  ...
  'terms.refundPolicyContact': 'For refund requests, please contact us at contact@elektr-ame.com with your order details.',
  'terms.shippingPolicy': 'Shipping and Delivery Policy',
  'terms.shippingPolicyText': 'As a digital service provider, Elektr-Âme does not ship physical products. All memberships and services are delivered digitally:',
  'terms.shippingPolicyItem1': 'Membership activation: Immediate upon payment confirmation',
  'terms.shippingPolicyItem2': 'Digital membership card: Available in member portal after approval',
  'terms.shippingPolicyItem3': 'Event tickets: Digital tickets sent via email',
  'terms.shippingPolicyItem4': 'Tax receipts: Sent via email within 7 business days of payment',
  'terms.returnsPolicy': 'Returns and Refunds Policy',
  'terms.returnsPolicyText': 'Since we provide digital services, the following applies:',
  'terms.returnsPolicyItem1': 'Membership fees: Refunds may be requested within 14 days of payment, subject to approval',
  'terms.returnsPolicyItem2': 'Refund requests must be submitted in writing via email to contact@elektr-ame.com',
  'terms.returnsPolicyItem3': 'Refunds will be processed within 14 business days of approval',
  'terms.returnsPolicyItem4': 'Refunded memberships will be deactivated immediately upon refund processing',
  'terms.payment': 'Payment Methods',
  'terms.paymentText': 'We accept payments through PAYCOMET and Stripe. All transactions are processed securely. Your payment information is encrypted and secure.',
  ...
  'terms.contactText': 'For questions about these terms and conditions, please contact us at contact@elektr-ame.com',
  ...
  'products.supportDescription': 'Support our community with any amount above €20 and receive tax deduction benefits',
  'products.supportFeatures': 'All Basic features, plus:',
  'products.supportFeature1': 'Tax deduction certificate (for Spanish tax residents)',
  'products.supportFeature2': 'Recognition as a supporter',
  'products.supportFeature3': 'Priority access to special events',

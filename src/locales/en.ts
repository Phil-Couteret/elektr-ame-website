...
export default {
  ...
  // Open Call (DJ)
  'openCall.seoTitle': 'Open Call for DJs | Elektr-Âme',
  'openCall.seoDescription': 'Apply to DJ at Elektr-Âme events. Submit your recorded mix and contact details.',
  'openCall.title': 'Open Call (for DJ)',
  'openCall.intro': 'Open call for DJ for Elektr-Âme events.',
  'openCall.email': 'Email',
  'openCall.whatsapp': 'WhatsApp',
  'openCall.firstName': 'First name',
  'openCall.lastName': 'Last name',
  'openCall.djName': 'DJ name',
  'openCall.musicalStyle': 'Musical style',
  'openCall.musicalStylePlaceholder': 'Describe your sound, influences, BPM range…',
  'openCall.mixLink': 'Link to your recorded mix (SoundCloud, Dropbox, etc.)',
  'openCall.mixLinkPlaceholder': 'https://…',
  'openCall.mixFile': 'Or upload your mix',
  'openCall.mixFileHint': 'Audio or ZIP. Maximum file size: 2 GB. If the upload fails, use a link instead.',
  'openCall.mixPreview': 'Preview your mix (plays in the page — nothing is uploaded until you submit)',
  'openCall.mixPreviewZip': 'ZIP files cannot be previewed in the browser; upload or use a link.',
  'openCall.mixRequired': 'Please provide a mix link or upload a file.',
  'openCall.mixLinkInvalid': 'Please enter a valid URL for your mix.',
  'openCall.submit': 'Send submission',
  'openCall.submitting': 'Sending…',
  'openCall.success': 'Thank you! We received your submission and will get back to you if there is a fit.',
  'openCall.error': 'Something went wrong. Please try again or email rrpp@elektr-ame.com.',
  'openCall.networkError': 'Network error. Please try again.',
  'openCall.fileTooLarge': 'File is too large. Maximum size is 2 GB.',
  'openCall.photo': 'Photo or logo (optional)',
  'openCall.photoHint': 'JPG, PNG, WebP, or GIF. Maximum size: 10 MB.',
  'openCall.photoTooLarge': 'Image is too large. Maximum size is 10 MB.',
  'openCall.promoConsent': 'I authorize Elektr-Âme to use my name, image, and session extract for promotion of current and future events organized by the association. Promotion may appear on the website, social networks, and any medium Elektr-Âme considers relevant for its communication.',
  'openCall.promoConsentError': 'You must accept this authorization to submit.',

  'admin.tabs.openCall': 'Open Call',
  'admin.openCall.title': 'Open Call (DJ) submissions',
  'admin.openCall.subtitle': 'Expand a row to listen to uploads (player), review details, and edit selection. In the list, file names link to download.',
  'admin.openCall.expandForPlayer': 'Expand row for in-browser player',
  'admin.openCall.listActive': 'Active',
  'admin.openCall.listArchived': 'Archived',
  'admin.openCall.listAll': 'All',
  'admin.openCall.badgeArchived': 'Archived',
  'admin.openCall.badgeFuture': 'Future session',
  'admin.openCall.archived': 'Archived',
  'admin.openCall.archivedHint': 'Hide from the active list; find under Archived.',
  'admin.openCall.futureSession': 'Future session',
  'admin.openCall.futureSessionHint': 'Mark for a possible upcoming slot (internal note).',
  'admin.openCall.deleteMixFile': 'Delete uploaded file from server',
  'admin.openCall.deleteMixTitle': 'Remove file from server?',
  'admin.openCall.deleteMixDescription': 'The uploaded mix will be deleted to free disk space. Links are not affected. This cannot be undone.',
  'admin.openCall.deleteMixConfirm': 'Delete file',
  'admin.openCall.deleteMixDone': 'File removed from server.',
  'admin.openCall.loading': 'Loading…',
  'admin.openCall.empty': 'No submissions yet.',
  'admin.openCall.emptyArchived': 'No archived submissions.',
  'admin.openCall.col.submitted': 'Submitted',
  'admin.openCall.col.dj': 'DJ name',
  'admin.openCall.col.email': 'Email',
  'admin.openCall.col.selected': 'Selected',
  'admin.openCall.col.mix': 'Mix',
  'admin.openCall.view': 'Expand to review',
  'admin.openCall.mixOpenLink': 'Open mix link',
  'admin.openCall.mixPlay': 'Listen in browser',
  'admin.openCall.mixDownload': 'Download file',
  'admin.openCall.mixZipHint': 'ZIP — download and open locally',
  'admin.openCall.detailTitle': 'Submission',
  'admin.openCall.readonly': 'Applicant',
  'admin.openCall.mixLink': 'Mix link',
  'admin.openCall.mixFile': 'Uploaded mix',
  'admin.openCall.photo': 'Photo / logo',
  'admin.openCall.promoConsent': 'Promo consent',
  'admin.openCall.yes': 'Yes',
  'admin.openCall.adminSection': 'Selection & rebooking',
  'admin.openCall.selected': 'Selected',
  'admin.openCall.selectionDate': 'Selection date',
  'admin.openCall.rebookingPossible': 'Rebooking possible',
  'admin.openCall.rebookingDates': 'Additional booking dates',
  'admin.openCall.addDate': 'Add date',
  'admin.openCall.removeDate': 'Remove',
  'admin.openCall.save': 'Save',
  'admin.openCall.saving': 'Saving…',
  'admin.openCall.saved': 'Saved.',
  'admin.openCall.saveError': 'Could not save.',
  'admin.openCall.cancel': 'Cancel',
  'admin.openCall.promoteToArtist': 'Add applicant to artists',
  'admin.openCall.promoteHint':
    'Creates an artist profile from this submission (DJ name, bio, photo, mix links). Requires Artists access.',
  'admin.openCall.promoteDone': 'Artist profile created.',
  ...
  'footer.craftedBy': 'Crafted by Phil C',
  ...
  'joinUs.and': 'and',
  'joinUs.privacyLink': 'Privacy Policy',
  ...
  'admin.membership.inProgress': 'In Progress',
  ...
  'admin.dialog.selectPaymentMethod': 'Select how they paid',
  'admin.dialog.paymentMethodHelp': 'Record how they paid (for pre-Stripe payments)',
  ...
  'portal.terms.title': 'Terms and Conditions',
  'portal.terms.requiredToSign': 'You must accept the terms and conditions to be an official member.',
  'portal.terms.acceptLabel': 'I accept the',
  'portal.terms.termsLink': 'Terms and Conditions',
  'portal.terms.and': 'and',
  'portal.terms.privacyLink': 'Privacy Policy',
  'portal.terms.acceptButton': 'Accept Terms',
  'portal.terms.submitting': 'Saving...',
  'portal.terms.mustAccept': 'Please check the box to accept the terms and conditions.',
  'portal.terms.acceptFailed': 'Failed to save. Please try again.',
  'portal.terms.acceptedTitle': 'Terms Accepted',
  'portal.terms.acceptedMessage': 'Thank you. You have accepted the terms and conditions.',
  'portal.terms.acceptedOn': 'You accepted the terms on',
  'portal.terms.viewTerms': 'View terms and conditions',
  'portal.terms.payFirst': 'Complete your payment to accept the terms',
  'portal.terms.payFirstDetail': 'Terms are accepted when you complete your membership payment (Stripe, cash, bank transfer, Paycomet, or other).',
  'portal.terms.goToPayments': 'Go to Payments',
  ...
  // Membership Types
  'portal.membership.inProgress': 'In Progress',
  'portal.membership.yearly': 'Yearly',
  'portal.membership.lifetime': 'Lifetime',
  'portal.membership.freeMember': 'Free Member',
  'portal.membership.basicMember': 'Basic Member (€20/year)',
  'portal.membership.sponsorMember': 'Sponsor Member (>€20/year)',
  'portal.membership.lifetimeMember': 'Lifetime Member',
  'portal.membership.freeDescription': 'Limited access - Newsletter only',
  'portal.membership.basicDescription': '€20/year - Full membership',
  'portal.membership.sponsorDescription': '>€20/year - Full membership + Tax deduction',
  ...
  'legal.legalRepresentative': 'Legal Representative',
  'legal.legalRepresentativeValue': 'Board of Directors',
  ...
  // Terms and Conditions - content in content/terms/terms-en.ts

  // Privacy Policy
  'privacy.title': 'Privacy Policy',
  'privacy.description': 'Privacy policy and data protection information for Elektr-Âme',
  'privacy.intro': 'Introduction',
  'privacy.introText': 'Elektr-Âme is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and protect your personal information.',
  'privacy.dataController': 'Data Controller',
  'privacy.dataControllerText': 'The data controller is:',
  'privacy.dataCollection': 'Data Collection',
  'privacy.dataCollectionText': 'We collect the following types of personal data:',
  'privacy.dataCollectionItem1': 'Contact information (name, email, phone)',
  'privacy.dataCollectionItem2': 'Membership information (membership type, payment status)',
  'privacy.dataCollectionItem3': 'Profile information (artist name, bio, social links)',
  'privacy.dataCollectionItem4': 'Payment information (processed securely through third-party payment processors)',
  'privacy.dataUse': 'Use of Data',
  'privacy.dataUseText': 'We use your personal data to:',
  'privacy.dataUseItem1': 'Process membership applications and payments',
  'privacy.dataUseItem2': 'Send membership-related communications',
  'privacy.dataUseItem3': 'Manage events and workshops',
  'privacy.dataUseItem4': 'Comply with legal obligations',
  'privacy.dataRetention': 'Data Retention',
  'privacy.dataRetentionText': 'We retain your personal data for as long as necessary to fulfill the purposes outlined in this policy, or as required by law.',
  'privacy.dataRights': 'Your Rights',
  'privacy.dataRightsText': 'Under GDPR, you have the right to:',
  'privacy.dataRightsItem1': 'Access your personal data',
  'privacy.dataRightsItem2': 'Rectify inaccurate data',
  'privacy.dataRightsItem3': 'Request deletion of your data',
  'privacy.dataRightsItem4': 'Object to processing of your data',
  'privacy.dataRightsItem5': 'Data portability',
  'privacy.cookies': 'Cookies',
  'privacy.cookiesText': 'We use cookies to improve your experience on our website. You can manage cookie preferences in your browser settings.',
  'privacy.security': 'Data Security',
  'privacy.securityText': 'We implement appropriate technical and organizational measures to protect your personal data against unauthorized access, alteration, disclosure, or destruction.',
  'privacy.contact': 'Contact',
  'privacy.contactText': 'For questions about this privacy policy or to exercise your rights, please contact us at contact@elektr-ame.com',

  // Membership Products
  'products.title': 'Membership Plans',
  'products.description': 'Choose your membership plan and join the Elektr-Âme community',
  'products.basicTitle': 'Basic Membership',
  'products.basicPrice': '€20',
  'products.basicPeriod': '/year',
  'products.basicDescription': 'Full membership access to the Elektr-Âme community',
  'products.basicFeatures': 'Features',
  'products.basicFeature1': 'Access to all community events',
  'products.basicFeature2': 'Digital membership card',
  'products.basicFeature3': 'Newsletter and updates',
  'products.basicFeature4': 'Member portal access',
  'products.basicFeature5': 'Tax deduction certificate (for Spanish tax residents)',
  'products.supportTitle': 'Support Membership',
  'products.supportPrice': 'From €21',
  'products.supportPeriod': '/year',
  'products.supportDescription': 'Support our community with any amount above €20',
  'products.supportFeatures': 'All Basic features, plus:',
  'products.supportFeature1': 'Recognition as a supporter',
  'products.supportFeature2': 'Priority access to special events',
  'products.buyNow': 'Join Now',
